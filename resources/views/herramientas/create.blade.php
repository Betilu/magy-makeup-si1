            ...
            <form action="{{ route('herramientas.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('cantidad') is-invalid @enderror"
                               id="cantidad" name="cantidad" value="{{ old('cantidad', 1) }}"
                               min="1" required
                               style="border-radius:10px; border:1px solid #dee2e6; padding:0.75rem;">
                        @error('cantidad')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('fechaAdquisicion') is-invalid @enderror"
                               id="fechaAdquisicion" name="fechaAdquisicion" value="{{ old('fechaAdquisicion') }}"
                               style="border-radius:10px; border:1px solid #dee2e6; padding:0.75rem;">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('observacion') is-invalid @enderror"
                              ...
                              style="border-radius:10px; border:1px solid #dee2e6; padding:0.75rem;">{{ old('observacion') }}</textarea>
                    @error('observacion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
